...
export const oracleIntegrations: Integration[] = [
  {
    ...
    documentationUrl: 'https://documents.bmc.com/supportu/9.0.21.300/en-US/Documentation/ODI_Data_Flow.htm',
    controlmDocUrl: 'https://documents.bmc.com/supportu/9.0.21.300/en-US/Documentation/ODI_Data_Flow.htm',
    githubUrl: 'https://github.com/BMCDBA/odi_data_flow',
  ...
  },
  {
    ...
    category: IntegrationCategory.ORACLE_CLOUD,
    documentationUrl: 'https://documents.bmc.com/supportu/9.0.21.300/en-US/Documentation/OCI_Data_Integration.htm',
  ...
  },
  {
    ...
    category: IntegrationCategory.ORACLE_CLOUD,
    documentationUrl: 'https://documents.bmc.com/supportu/9.0.21.300/en-US/Documentation/OCI_Data_Science.htm',
  ...
  },
  {
    ...
    category: IntegrationCategory.ORACLE_CLOUD,
    documentationUrl: 'https://documents.bmc.com/supportu/9.0.21.300/en-US/Documentation/OCI_Functions.htm',
  ...
  },
  {
    ...
    category: IntegrationCategory.ORACLE_CLOUD,
    documentationUrl: 'https://documents.bmc.com/supportu/9.0.21.300/en-US/Documentation/OCI_VM.htm',
