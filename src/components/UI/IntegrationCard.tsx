...
const getServiceLogo = (integrationId: string): string => {
  const logoMap: Record<string, string> = {
    ...
    'astronomer': 'https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/astronomer.svg',
    ...
    'rubrik': 'https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/rubrik.svg',
    ...
    'alteryx-trifacta':'https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/trifacta.svg'
  };
